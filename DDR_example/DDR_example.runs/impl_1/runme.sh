...
HD_PWD='C:/Users/jwk50866/Documents/GitHub/Nexys_A7_DDR_example/DDR_example/DDR_example.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log DDR_example_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source DDR_example_top.tcl -notrace
