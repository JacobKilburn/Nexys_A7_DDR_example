...
HD_PWD='C:/Users/jwk50866/Documents/GitHub/Nexys_A7_DDR_example/DDR_example/DDR_example.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DDR_example_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DDR_example_top.tcl
