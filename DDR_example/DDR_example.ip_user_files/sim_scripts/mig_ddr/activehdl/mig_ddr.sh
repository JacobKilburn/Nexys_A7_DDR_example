...
#                script (type 'mig_ddr.sh -help' for more information).
#
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Users/jwk50866/Documents/GitHub/Nexys_A7_DDR_example/DDR_example/DDR_example.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
