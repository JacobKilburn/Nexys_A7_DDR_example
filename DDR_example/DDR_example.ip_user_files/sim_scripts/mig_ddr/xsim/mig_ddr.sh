...
#
# Script generated by Vivado on Fri May 02 13:13:59 -0400 2025
...
#
# Usage        : mig_ddr.sh
#                mig_ddr.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                mig_ddr.sh [-reset_run]
#                mig_ddr.sh [-reset_log]
#                mig_ddr.sh [-help]
#
...
# script info
echo -e "mig_ddr.sh - Script generated by export_simulation (Vivado v2024.2.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./mig_ddr.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot mig_ddr xil_defaultlib.mig_ddr xil_defaultlib.glbl -log elaborate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb mig_ddr.wdb xsim.dir libdpi.so)
...
Usage: mig_ddr.sh [-step]\n\
Usage: mig_ddr.sh [-lib_map_path]\n\
Usage: mig_ddr.sh [-reset_run]\n\
Usage: mig_ddr.sh [-reset_log]\n\
Usage: mig_ddr.sh [-keep_index]\n\
